...
- La fonction reward n'atteint jamais zéro (elle a été concue pour que ce soit la valeur maximale théorique). Le modèle se satisfait donc d'un **sous-optimum**.
